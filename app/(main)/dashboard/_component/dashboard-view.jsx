  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Investment Activity</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Key Competencies</CardTitle>
      ...
      <Card className="col-span-4">
        <CardHeader>
          <CardTitle>Compensation by Role</CardTitle>
          <CardDescription>
            Displaying minimum, median, and maximum compensation (in thousands)
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salaryData}>
                ...
                />
                <Bar dataKey="min" fill="#94a3b8" name="Min (K)" />
                <Bar dataKey="median" fill="#64748b" name="Median (K)" />
                <Bar dataKey="max" fill="#475569" name="Max (K)" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
